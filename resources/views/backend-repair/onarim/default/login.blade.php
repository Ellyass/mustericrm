...
<head>
    ...
    <style type="text/css">
        .login-page {
            background: url("/storage/images/login/onarim.jpg") no-repeat center center fixed;
...
<div class="login-box">
    <div class="login-box-body">
        <div class="login-logo">
            <a href="{{route('onarim.default.Login')}}"><b>Onarım</b> CRM</a>
        </div>
        ...
        <form action="{{ route('onarim.default.Authenticate') }}" method="post">
            @csrf
